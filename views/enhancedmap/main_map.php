 ...
 * @Date	   2012-06-06
 * Purpose:	   Map view for the admin map
 *             This file is adapted from the file Ushahidi_Web/themes/default/views/main.php
 *             Originally written by the Ushahidi Team
 * Inputs:     $map_id - HTML element id of the map itself. Great for a $("#<?php echo $map_id?>") type function
 *             $map_status_id - HTML element id of map status. Great for a $("#<?php echo $map_status_id?>") type function
 * Outputs:    HTML
 *
