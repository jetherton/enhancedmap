 ...
 * @Date	   2012-06-06
 * Purpose:	   timeline view for the admin map
 ...
 * Inputs:     $slider_holder_id - HTML element id of the slider and drop downs. Great for a $("#<?php echo $slider_holder_id?>") type function
 *             $graph_id - HTML element id of timeline. Great for a $("#<?php echo $graph_id?>") type function
